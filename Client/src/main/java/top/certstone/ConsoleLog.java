...
public class ConsoleLog {
    ...
    public static void sendMsg(Massage msg) {
        if (msg.getReceiver()!=null)System.out.println("[INFO]sendMsg: " + getSenderName(msg) + " to " + msg.getReceiver().getName()+"("+msg.getSender().getUUID().substring(msg.getSender().getUUID().length()-12)+")" + " : " + msg.getContent());
